...
Route::get('/Estudiante/Registo/curso/editar/estudiante/{id}',[App\Http\Controllers\escuelaController::class, 'estudiest'])->name('editarestudent');
Route::get('/Estudiante/Registo/tutor/nuevo',[App\Http\Controllers\UsrController::class, 'formtu'])->name('formulatutor');
Route::get('/Estudiante/Registo/cursos/registrado',[App\Http\Controllers\escuelaController::class, 'estudentscur'])->name('miscursos');
Route::get('/Estudiante/Registo/tutor/mis/estudiantes',[App\Http\Controllers\escuelaController::class, 'tutorescol'])->name('misestude');
