                        ...
                        <div class="card-body">
                            ...
                            @csrf
                                  ...
                                  <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                       <select class="form-control" name="gest" id="input-name" class="form-group " required="true" aria-required="true">
                                          ...
                                          <option value="{{ $datos->id_gest }}">Seleccionar Gestion</option>
                                  ...
                                  <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                       <select class="form-control" name="cur" id="input-name" class="form-group " required="true" aria-required="true">
                                          ...
                                          <option value="{{ $datos->id_curso }}">Seleccionar Curso</option>
                                  ...
                                  <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                       <select class="form-control" name="para" id="input-name" class="form-group " required="true" aria-required="true">
                                          @foreach($para as $par)
                                          <option value="{{ $datos->id_para }}">Seleccionar Paralelo</option>
                              ...
                              <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                          <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="namEs" id="input-name" type="text" placeholder="{{ __('Nombre') }}" value="{{ old('namEs',$datos->nombre) }}" minlength="4" maxlength="25" required="true" aria-required="true"/>
                                          @if ($errors->has('name'))
                                            <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                          @endif
                                        </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                          <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="apelliPEs" id="input-name" type="text" placeholder="{{ __('Apellido Paterno') }}" value="{{ old('apelliPEs',$datos->apepa) }}" required="true" minlength="4" maxlength="25" minlength="4" maxlength="25" aria-required="true"/>
                                          @if ($errors->has('name'))
                                            <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                          @endif
                                        </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                          <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="apelliMEs" id="input-name" type="text" placeholder="{{ __('Apellido Materno') }}" value="{{ old('apelliMEs',$datos->apema) }}" required="true" minlength="4" maxlength="25" aria-required="true"/>
                                          @if ($errors->has('name'))
                                            <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                          @endif
                                        </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                          <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="CIEs" id="input-name" type="text" patter="" placeholder="{{ __('Numero De Cedula De Identidad') }}" value="{{ old('CIEs',$datos->ci) }}" required="true"  aria-required="true"/>
                                          @if ($errors->has('name'))
                                            <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                          @endif
                                        </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                          <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="emailEs" id="input-email" type="email" placeholder="{{ __('Email') }}" value="{{ old('emailEs',$datos->email) }}" minlength="4" maxlength="25" required />
                                          @if ($errors->has('email'))
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                          <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="telefonoEs" id="input-name" type="text" placeholder="{{ __('Numero Telefonico o Celular') }}" value="{{ old('telefonoEs',$datos->telefono) }}" required="true" minlength="6" maxlength="9" aria-required="true"/>
                                          @if ($errors->has('name'))
                                            <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                          @endif
                                        </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            ...
                                            <option value="{{ $datos->vive }}">Seleccionar</option>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            ...
                                            <option value="{{ $datos->trabaja }}">Seleccionar</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                          @if ($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            ...
                                            <option value="{{ $datos->luz_f }}">Seleccionar</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                          @if ($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            ...
                                            <option value="{{ $datos->sexo }}">Seleccionar Genero</option>
                            ...
                            <div id="unidad" class="form-group row" >
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="codigo" id="input-name" type="text" placeholder="{{ __('Buscar Tutor') }}" value="{{ old('codigo',$codpater->ci) }}" required="true" aria-required="true" list="select"/>
                                      <datalist id="select" >
                                          @foreach($padr as $pad)
                                ...
                                <div class="col-sm-9">
                                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                      ...
                                      <option value="{{ $codpater->tipo_p }}">Seleccionar Grado de Tutor</option>
