        ...
        <div class="col-md-8">
            <div class="card">
                    <div class="card-header"><h3>Formulario De Registros</h3></div>
                        <div class="card-body">
                          <form method="post" action="{{route('registnuevo')}}" autocomplete="off" class="cmxform form-horizontal style-form" id="signupForm" method="get" action=""
                          ...
                          @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="nameTu" id="input-name" type="text" placeholder="{{ __('Nombre') }}" value="{{ old('nameTu') }}" minlength="4" maxlength="25" required="true" aria-required="true"/>
                                    @if ($errors->has('name'))
                                      <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                    @endif
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="apelliPTu" id="input-name" type="text" placeholder="{{ __('Apellido Paterno') }}" value="{{ old('apelliPTu') }}" required="true" minlength="4" maxlength="25" minlength="4" maxlength="25" aria-required="true"/>
                                    @if ($errors->has('name'))
                                      <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                    @endif
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="apelliMTu" id="input-name" type="text" placeholder="{{ __('Apellido Materno') }}" value="{{ old('apelliMTu') }}" required="true" minlength="4" maxlength="25" aria-required="true"/>
                                    @if ($errors->has('name'))
                                      <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                    @endif
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="CITu" id="input-name" type="text" patter="" placeholder="{{ __('Numero De Cedula De Identidad') }}" value="{{ old('CITu') }}" required="true"  aria-required="true"/>
                                    @if ($errors->has('name'))
                                      <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                    @endif
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="emailTu" id="input-email" type="email" placeholder="{{ __('Email') }}" value="{{ old('emailTu') }}" minlength="4" maxlength="25" required />
                                    @if ($errors->has('email'))
                                      <span id="email-error" class="error text-danger" for="input-email">{{ $errors->first('email') }}</span>
                                    @endif
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="telefonoTu" id="input-name" type="text" placeholder="{{ __('Numero Telefonico o Celular') }}" value="{{ old('telefonoTu') }}" required="true" minlength="6" maxlength="9" aria-required="true"/>
                                    @if ($errors->has('name'))
                                      <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                    @endif
                                  </div>
