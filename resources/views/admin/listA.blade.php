...
<div class="right_col" role="main">
   ...
   <div class="row">
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              <div class="x_title">
                <h2>Administradores Registrados en Sistema <small>Users</small></h2>
              ...
              <div class="x_content">
                ...
                <p class="text-muted font-13 m-b-30">
                  Administradores en sistema, para mantener informacion constante en el sistema
                </p>
                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                 ...
                 <td class="td-actions text-right">
                       ...
                       <form action={{-- "{{ route('user.destroy', $user) }}" --}}  method="post">
                             ...
                             <a href="{{route('editaruser',$id=$user->id_usr)}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
                             <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>

                            </form>

                       @else
                       <a href="{{route('infoRut',$user->id_usr)}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
